...
class _MapPageState extends State<MapPage> {
  ...
  Future<List<NearByAmbulanceResult>> getNearby(
    ...
    var response = await https.get(
      Uri.parse(
        "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=$latitude,$longitude&radius=30000&type=hospital&keyword=hospital&key=${sharedPreferences.getString('key')}",
      ),
    );
